...
<c:set var="menu2" value="${menu.items['public']}" scope="request" />
<m:masterMenu print="${print}" title="${title}" logoutmenu="false" menulink="behandlung" caption="${caption}" menuitem="${menuitem}"  submenuitem="${submenuitem}">
